...
import 'screens/bloc/user_bloc.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UserBloc>(child: MaterialApp(
        ...
        home: SplashScreen()//SplashScreen()//HomeScreen()//SignUpPage()//OnboardingPage()//MyHomePage(title: 'Flutter Demo Home Page'),
    ), bloc: UserBloc());
  }
}
...
const int _redPrimaryValue = 0xFFD32F2F;
